...
public class EditProfileActivity extends Activity implements OnClickListener, ValidationListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (currentUser != null) {
			...
			if (userStr != null) {
				...
				hours.setSelection(Integer.parseInt(sharedPreferences.getString("hours", null)));
			} else {
				// do stuff with the user
					...
					public void done(List<ParseObject> movObjs, ParseException arg1) {
						...
						if (arg1 == null) {
							for (ParseObject object : movObjs) {
								...
								editor.putString("hours", hours.getSelectedItem().toString());
								editor.commit();
	...
	AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
				...
				movInfo.setObjectId(sharedPreferences.getString("hoursID", null));
